...
function createFeaturedSpeakersTemplate(featureAttendees) {
  if (!featureAttendees.length) return '';

  const attendees = featureAttendees.map((attende) => {
    return `
            ...
            <div class="cards__card">
              ...
              <div class="cards__card__info">
                ...
                <div class="cards__card__info__speakers">
                  <ul>
                    ${createFeaturedSpeakersTemplate(room.featureAttendees)}
